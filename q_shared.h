...
// END JOSEPH
#define	STAT_TIMER				10 // Papa - the hud timer - kingpin doesn't give you many hud variables to work with
...
extern char num_flares;		// this also goes into the configstring, at the start of the lightflare section
// done.
