...
void thug_firegun( edict_t *self, vec3_t ofs )
{
	...
	vec3_t	aim;
	vec3_t	offset;
	int damage=3; // assault virgin11beta
	int		flash_number;
	float	dist;
...
//	self->cast_info.move_start_climb = &thug_move_st_clmb;
	...
	if (self->spawnflags & 1) self->cast_info.aiflags |= AI_FASTWALK; // assault virgin 11 delta

	// assault virgin11beta
	self->count = -1;
...
/************************************************
qboolean CheckScripts(edict_t *self)
...
//	gi.bprintf(PRINT_HIGH,"CheckScripts self->count = %i\n",self->count);
	if(!strcmp(self->classname,"cast_punk"))
	{
		if(CheckPunkScripts(self)) return true;
		else return false;
	}
	else if(!strcmp(self->classname,"cast_dog"))
	{
		if(CheckDogScripts(self)) return true;
		else return false;
	}
	else if(!strcmp(self->classname,"cast_bitch"))
	{
		if(CheckBitchScripts(self)) return true;
		else return false;
	}
	else if(!strcmp(self->classname,"cast_thug_sit"))
	{
		if(CheckThug2Scripts(self)) return true;
		else return false;
	}
	else if(!strcmp(self->classname,"cast_runt"))
	{
		if(CheckRuntScripts(self)) return true;
		else return false;
	}
	else if(!strcmp(self->classname,"cast_shorty"))
	{
		if(CheckShortyScripts(self)) return true;
		else return false;
	}
	else if(!strcmp(self->classname,"cast_whore"))
	{
		if(CheckWhoreScripts(self)) return true;
		else return false;
	}

	if(    self->count > -1 
		&& !strcmp(self->classname,"cast_thug") 
		&& self->gesture[n] ) // assault virgin11beta
	{
		...
		else if(!strcmp(self->gesture[n],"thug_attack"))	
		{
		...
		n = self->option - self->count;
			 ...
			 if(!strcmp(self->gesture[n],"wait") || !strcmp(self->gesture[n],"thug_move_amb_stand") )
		   self->cast_info.currentmove = &thug_move_amb_stand;
		else if(!strcmp(self->gesture[n],"thug_move_talk1"))
		   self->cast_info.currentmove = &thug_move_talk1;
		else if(!strcmp(self->gesture[n],"thug_move_handwave"))
		   self->cast_info.currentmove = &thug_move_handwave;
		else if(!strcmp(self->gesture[n],"thug_move_nod_yes"))
		   self->cast_info.currentmove = &thug_move_nod_yes;
		else if(!strcmp(self->gesture[n],"thug_move_whoa"))
		   self->cast_info.currentmove = &thug_move_whoa;
		else if(!strcmp(self->gesture[n],"thug_move_crch_grab"))
		   self->cast_info.currentmove = &thug_move_crch_grab;
		else if(!strcmp(self->gesture[n],"thug_move_up_yours"))
		   self->cast_info.currentmove = &thug_move_up_yours;
		else if(!strcmp(self->gesture[n],"thug_move_nod_no"))
		   self->cast_info.currentmove = &thug_move_nod_no;
		else if(!strcmp(self->gesture[n],"thug_move_pull_guns"))
		   self->cast_info.currentmove = &thug_move_pull_guns;
		else if(!strcmp(self->gesture[n],"thug_move_shoot"))
		   self->cast_info.currentmove = &thug_move_shoot;
		else if(!strcmp(self->gesture[n],"thug_move_reload"))
		   self->cast_info.currentmove = &thug_move_reload;
		else if(!strcmp(self->gesture[n],"thug_move_kneel"))
		   self->cast_info.currentmove = &thug_move_kneel;
		else if(!strcmp(self->gesture[n],"thug_move_kneel_up"))
		   self->cast_info.currentmove = &thug_move_kneel_up;
		else if(!strcmp(self->gesture[n],"thug_move_knl_shoot"))
		   self->cast_info.currentmove = &thug_move_knl_shoot;
		else if(!strcmp(self->gesture[n],"thug_move_melee1"))
		   self->cast_info.currentmove = &thug_move_melee1;
		else if(!strcmp(self->gesture[n],"thug_move_melee2"))
		   self->cast_info.currentmove = &thug_move_melee2;
		else if(!strcmp(self->gesture[n],"thug_move_melee3"))
		   self->cast_info.currentmove = &thug_move_melee3;
		else if(!strcmp(self->gesture[n],"thug_move_melee4"))
		   self->cast_info.currentmove = &thug_move_melee4;
		else if(!strcmp(self->gesture[n],"thug_move_melee5"))
		   self->cast_info.currentmove = &thug_move_melee5;
		else if(!strcmp(self->gesture[n],"thug_move_run_melee"))
		   self->cast_info.currentmove = &thug_move_run_melee;
		else if(!strcmp(self->gesture[n],"thug_move_jump"))
		   self->cast_info.currentmove = &thug_move_jump;
		else if(!strcmp(self->gesture[n],"thug_move_walk_shoot"))
		   self->cast_info.currentmove = &thug_move_walk_shoot;
		else if(!strcmp(self->gesture[n],"thug_move_reverse_walk_shoot"))
		   self->cast_info.currentmove = &thug_move_reverse_walk_shoot;
		else if(!strcmp(self->gesture[n],"thug_move_walk_guns_dn"))
		   self->cast_info.currentmove = &thug_move_walk_guns_dn;
		else if(!strcmp(self->gesture[n],"thug_move_avoid_walk"))
		   self->cast_info.currentmove = &thug_move_avoid_walk;
		else if(!strcmp(self->gesture[n],"thug_move_avoid_reverse_walk"))
		   self->cast_info.currentmove = &thug_move_avoid_reverse_walk;
		else if(!strcmp(self->gesture[n],"thug_move_avoid_run"))
		   self->cast_info.currentmove = &thug_move_avoid_run;
		else if(!strcmp(self->gesture[n],"thug_move_avoid_reverse_run"))
		   self->cast_info.currentmove = &thug_move_avoid_reverse_run;
		else if(!strcmp(self->gesture[n],"thug_move_run_shoot"))
		   self->cast_info.currentmove = &thug_move_run_shoot;
		else if(!strcmp(self->gesture[n],"thug_move_reverse_run_shoot"))
		   self->cast_info.currentmove = &thug_move_reverse_run_shoot;
		else if(!strcmp(self->gesture[n],"thug_move_run_guns_dn"))
		   self->cast_info.currentmove = &thug_move_run_guns_dn;
		else if(!strcmp(self->gesture[n],"thug_move_run_on_fire"))
		   self->cast_info.currentmove = &thug_move_run_on_fire;
		else if(!strcmp(self->gesture[n],"thug_move_lside_run"))
		   self->cast_info.currentmove = &thug_move_lside_run;
		else if(!strcmp(self->gesture[n],"thug_move_rside_run"))
		   self->cast_info.currentmove = &thug_move_rside_run;
		else if(!strcmp(self->gesture[n],"thug_move_lside_step"))
		   self->cast_info.currentmove = &thug_move_lside_step;
		else if(!strcmp(self->gesture[n],"thug_move_rside_step"))
		   self->cast_info.currentmove = &thug_move_rside_step;
		else if(!strcmp(self->gesture[n],"thug_move_evade"))
		   self->cast_info.currentmove = &thug_move_evade;
		else if(!strcmp(self->gesture[n],"thug_move_evade_amb"))
		   self->cast_info.currentmove = &thug_move_evade_amb;
		else if(!strcmp(self->gesture[n],"thug_move_evade_stand"))
		   self->cast_info.currentmove = &thug_move_evade_stand;
		else if(!strcmp(self->gesture[n],"thug_move_evade_adjust"))
		   self->cast_info.currentmove = &thug_move_evade_adjust;
		else if(!strcmp(self->gesture[n],"thug_move_clmb_loop"))
		   self->cast_info.currentmove = &thug_move_clmb_loop;
		else if(!strcmp(self->gesture[n],"thug_move_clmb_jmp"))
		   self->cast_info.currentmove = &thug_move_clmb_jmp;
		else if(!strcmp(self->gesture[n],"thug_move_clmb_over"))
		   self->cast_info.currentmove = &thug_move_clmb_over;
		else if(!strcmp(self->gesture[n],"thug_move_crch_dth"))
		   self->cast_info.currentmove = &thug_move_crch_dth;
		else if(!strcmp(self->gesture[n],"thug_move_crch_knl_dn"))
		   self->cast_info.currentmove = &thug_move_crch_knl_dn;
		else if(!strcmp(self->gesture[n],"thug_move_stand_up"))
		   self->cast_info.currentmove = &thug_move_stand_up;
		else if(!strcmp(self->gesture[n],"thug_move_crch_amb_sdt"))
		   self->cast_info.currentmove = &thug_move_crch_amb_sdt;
		else if(!strcmp(self->gesture[n],"thug_move_crch_shoot"))
		   self->cast_info.currentmove = &thug_move_crch_shoot;
		else if(!strcmp(self->gesture[n],"thug_move_crouch_avoid_walk"))
		   self->cast_info.currentmove = &thug_move_crouch_avoid_walk;
		else if(!strcmp(self->gesture[n],"thug_move_crouch_shfl"))
		   self->cast_info.currentmove = &thug_move_crouch_shfl;
		else if(!strcmp(self->gesture[n],"thug_move_crouch_walk"))
		   self->cast_info.currentmove = &thug_move_crouch_walk;
		else if(!strcmp(self->gesture[n],"thug_move_crouch_pain1"))
		   self->cast_info.currentmove = &thug_move_crouch_pain1;
		else if(!strcmp(self->gesture[n],"thug_move_crouch_pain2"))
		   self->cast_info.currentmove = &thug_move_crouch_pain2;
		else if(!strcmp(self->gesture[n],"thug_move_crouch_pain3"))
		   self->cast_info.currentmove = &thug_move_crouch_pain3;
		else if(!strcmp(self->gesture[n],"thug_move_low_melee1"))
		   self->cast_info.currentmove = &thug_move_low_melee1;
		else if(!strcmp(self->gesture[n],"thug_move_pain_Rarm"))
		   self->cast_info.currentmove = &thug_move_pain_Rarm;
		else if(!strcmp(self->gesture[n],"thug_move_pain_Larm"))
		   self->cast_info.currentmove = &thug_move_pain_Larm;
		else if(!strcmp(self->gesture[n],"thug_move_pain_chest"))
		   self->cast_info.currentmove = &thug_move_pain_chest;
		else if(!strcmp(self->gesture[n],"thug_move_pain_head"))
		   self->cast_info.currentmove = &thug_move_pain_head;
		else if(!strcmp(self->gesture[n],"thug_move_pain_Rleg"))
		   self->cast_info.currentmove = &thug_move_pain_Rleg;
		else if(!strcmp(self->gesture[n],"thug_move_pain_Lleg"))
		   self->cast_info.currentmove = &thug_move_pain_Lleg;
		else if(!strcmp(self->gesture[n],"thug_move_pain_crch"))
		   self->cast_info.currentmove = &thug_move_pain_crch;
		else if(!strcmp(self->gesture[n],"thug_move_pain_butt"))
		   self->cast_info.currentmove = &thug_move_pain_butt;
		else if(!strcmp(self->gesture[n],"thug_move_nw_pain_Rarm"))
		   self->cast_info.currentmove = &thug_move_nw_pain_Rarm;
		else if(!strcmp(self->gesture[n],"thug_move_nw_pain_Larm"))
		   self->cast_info.currentmove = &thug_move_nw_pain_Larm;
		else if(!strcmp(self->gesture[n],"thug_move_nw_pain_chst"))
		   self->cast_info.currentmove = &thug_move_nw_pain_chst;
		else if(!strcmp(self->gesture[n],"thug_move_nw_pain_head"))
		   self->cast_info.currentmove = &thug_move_nw_pain_head;
		else if(!strcmp(self->gesture[n],"thug_move_nw_pain_Rleg"))
		   self->cast_info.currentmove = &thug_move_nw_pain_Rleg;
		else if(!strcmp(self->gesture[n],"thug_move_nw_pain_Lleg"))
		   self->cast_info.currentmove = &thug_move_nw_pain_Lleg;
		else if(!strcmp(self->gesture[n],"thug_move_nw_pain_crch"))
		   self->cast_info.currentmove = &thug_move_nw_pain_crch;
		else if(!strcmp(self->gesture[n],"thug_move_nw_pain_butt"))
		   self->cast_info.currentmove = &thug_move_nw_pain_butt;
		else if(!strcmp(self->gesture[n],"thug_move_death1"))
		   self->cast_info.currentmove = &thug_move_death1;
		else if(!strcmp(self->gesture[n],"thug_move_death2"))
		   self->cast_info.currentmove = &thug_move_death2;
		else if(!strcmp(self->gesture[n],"thug_move_death3"))
		   self->cast_info.currentmove = &thug_move_death3;
		else if(!strcmp(self->gesture[n],"thug_move_death4"))
		   self->cast_info.currentmove = &thug_move_death4;
		else if(!strcmp(self->gesture[n],"thug_move_death5"))
		   self->cast_info.currentmove = &thug_move_death5;
		else if(!strcmp(self->gesture[n],"thug_move_walk_dokey"))
		   self->cast_info.currentmove = &thug_move_walk_dokey;
		else if(!strcmp(self->gesture[n],"thug_move_crch_dokey"))
		   self->cast_info.currentmove = &thug_move_crch_dokey;
		else self->cast_info.currentmove = &thug_move_amb_stand;
