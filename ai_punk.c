...
skipbail:
	...
	else if (self->spawnflags & PUNK_SHOTGUN)
	{
		...
		damage = 6;
		if(self->dmg) damage = self->dmg;
		cast_fire_shotgun (self, start, aim, damage, 2, DEFAULT_SHOTGUN_HSPREAD, DEFAULT_SHOTGUN_VSPREAD, DEFAULT_SHOTGUN_COUNT, flash_number); 
	...
	else if (self->spawnflags & PUNK_HMG)
	{
		damage = 15;
		if(self->dmg) damage = self->dmg;
		fire_bullet (self, start, aim, damage, (4*damage), DEFAULT_BULLET_HSPREAD>>self->acc, DEFAULT_BULLET_VSPREAD>>self->acc, MOD_BARMACHINEGUN);
		{
			if (self->lastduration == 1)
			{
				gi.sound(self, CHAN_WEAPON, gi.soundindex("weapons/hmg/hmg.wav"), 1, ATTN_NORM, 0);
...
/************************************************
qboolean CheckPunkScripts(edict_t *self)
...
Allows scripts to run for cast_punk etc.
*************************************************/
...
qboolean CheckPunkScripts(edict_t *self)
{
	...
	if(    self->count > -1 
		&& !strcmp(self->classname,"cast_punk") 
		&& self->gesture[n] ) // assault virgin11beta
	{

		CHECKPLAYSOUND

		else if(!strcmp(self->gesture[n],"punk_attack"))	
		{
		...
		n = self->option - self->count;
			 ...
			 if(!strcmp(self->gesture[n],"wait") || !strcmp(self->gesture[n],"punk_move_stand") )
		   self->cast_info.currentmove = &punk_move_stand;
		else if(!strcmp(self->gesture[n],"punk_move_tg_shoot"))
		   self->cast_info.currentmove = &punk_move_tg_shoot;
		else if(!strcmp(self->gesture[n],"punk_move_hmg_shoot"))
		   self->cast_info.currentmove = &punk_move_hmg_shoot;
		else if(!strcmp(self->gesture[n],"punk_move_bazooka_shoot"))
		   self->cast_info.currentmove = &punk_move_bazooka_shoot;
		else if(!strcmp(self->gesture[n],"punk_move_grenade_shoot"))
		   self->cast_info.currentmove = &punk_move_grenade_shoot;
		else if(!strcmp(self->gesture[n],"punk_move_flamegun_shoot"))
		   self->cast_info.currentmove = &punk_move_flamegun_shoot;
		else if(!strcmp(self->gesture[n],"punk_move_shg_shoot"))
		   self->cast_info.currentmove = &punk_move_shg_shoot;
		else if(!strcmp(self->gesture[n],"punk_move_tg_reload"))
		   self->cast_info.currentmove = &punk_move_tg_reload;
		else if(!strcmp(self->gesture[n],"punk_move_talk1"))
		   self->cast_info.currentmove = &punk_move_talk1;
		else if(!strcmp(self->gesture[n],"punk_move_talk2"))
		   self->cast_info.currentmove = &punk_move_talk2;
		else if(!strcmp(self->gesture[n],"punk_move_talk3"))
		   self->cast_info.currentmove = &punk_move_talk3;
		else if(!strcmp(self->gesture[n],"punk_move_talk4"))
		   self->cast_info.currentmove = &punk_move_talk4;
		else if(!strcmp(self->gesture[n],"punk_move_talk5"))
		   self->cast_info.currentmove = &punk_move_talk5;
		else if(!strcmp(self->gesture[n],"punk_move_talk6"))
		   self->cast_info.currentmove = &punk_move_talk6;
		else if(!strcmp(self->gesture[n],"punk_move_head_wipe"))
		   self->cast_info.currentmove = &punk_move_head_wipe;
		else if(!strcmp(self->gesture[n],"punk_move_pain_Rarm"))
		   self->cast_info.currentmove = &punk_move_pain_Rarm;
		else if(!strcmp(self->gesture[n],"punk_move_pain_Larm"))
		   self->cast_info.currentmove = &punk_move_pain_Larm;
		else if(!strcmp(self->gesture[n],"punk_move_pain_chest"))
		   self->cast_info.currentmove = &punk_move_pain_chest;
		else if(!strcmp(self->gesture[n],"punk_move_pain_head"))
		   self->cast_info.currentmove = &punk_move_pain_head;
		else if(!strcmp(self->gesture[n],"punk_move_pain_Rleg"))
		   self->cast_info.currentmove = &punk_move_pain_Rleg;
		else if(!strcmp(self->gesture[n],"punk_move_pain_Lleg"))
		   self->cast_info.currentmove = &punk_move_pain_Lleg;
		else if(!strcmp(self->gesture[n],"punk_move_pain_crch"))
		   self->cast_info.currentmove = &punk_move_pain_crch;
		else if(!strcmp(self->gesture[n],"punk_move_pain_butt"))
		   self->cast_info.currentmove = &punk_move_pain_butt;
		else if(!strcmp(self->gesture[n],"punk_move_jump"))
		   self->cast_info.currentmove = &punk_move_jump;
		else if(!strcmp(self->gesture[n],"punk_move_death1"))
		   self->cast_info.currentmove = &punk_move_death1;
		else if(!strcmp(self->gesture[n],"punk_move_death2"))
		   self->cast_info.currentmove = &punk_move_death2;
		else if(!strcmp(self->gesture[n],"punk_move_death3"))
		   self->cast_info.currentmove = &punk_move_death3;
		else if(!strcmp(self->gesture[n],"punk_move_death4"))
		   self->cast_info.currentmove = &punk_move_death4;
		else if(!strcmp(self->gesture[n],"punk_move_crh_shuf"))
		   self->cast_info.currentmove = &punk_move_crh_shuf;
		else if(!strcmp(self->gesture[n],"punk_move_crouch_walk"))
		   self->cast_info.currentmove = &punk_move_crouch_walk;
		else if(!strcmp(self->gesture[n],"punk_move_crouch_painC"))
		   self->cast_info.currentmove = &punk_move_crouch_painC;
		else if(!strcmp(self->gesture[n],"punk_move_crouch_painL"))
		   self->cast_info.currentmove = &punk_move_crouch_painL;
		else if(!strcmp(self->gesture[n],"punk_move_crouch_painR"))
		   self->cast_info.currentmove = &punk_move_crouch_painR;
		else if(!strcmp(self->gesture[n],"punk_move_crouch_shoot"))
		   self->cast_info.currentmove = &punk_move_crouch_shoot;
		else if(!strcmp(self->gesture[n],"punk_move_crch_shg_sht"))
		   self->cast_info.currentmove = &punk_move_crch_shg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_crouch_stand_down"))
		   self->cast_info.currentmove = &punk_move_crouch_stand_down;
		else if(!strcmp(self->gesture[n],"punk_move_crouch_stand_up"))
		   self->cast_info.currentmove = &punk_move_crouch_stand_up;
		else if(!strcmp(self->gesture[n],"punk_move_crch_astand"))
		   self->cast_info.currentmove = &punk_move_crch_astand;
		else if(!strcmp(self->gesture[n],"punk_move_crouch_death"))
		   self->cast_info.currentmove = &punk_move_crouch_death;
		else if(!strcmp(self->gesture[n],"punk_move_clmb_loop"))
		   self->cast_info.currentmove = &punk_move_clmb_loop;
		else if(!strcmp(self->gesture[n],"punk_move_clmb_over"))
		   self->cast_info.currentmove = &punk_move_clmb_over;
		else if(!strcmp(self->gesture[n],"punk_move_lside_step"))
		   self->cast_info.currentmove = &punk_move_lside_step;
		else if(!strcmp(self->gesture[n],"punk_move_rside_step"))
		   self->cast_info.currentmove = &punk_move_rside_step;
		else if(!strcmp(self->gesture[n],"punk_move_walk_nw"))
		   self->cast_info.currentmove = &punk_move_walk_nw;
		else if(!strcmp(self->gesture[n],"punk_move_walk_tg_sht"))
		   self->cast_info.currentmove = &punk_move_walk_tg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_walk_hmg_sht"))
		   self->cast_info.currentmove = &punk_move_walk_hmg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_walk_bazooka_sht"))
		   self->cast_info.currentmove = &punk_move_walk_bazooka_sht;
		else if(!strcmp(self->gesture[n],"punk_move_walk_grenade_sht"))
		   self->cast_info.currentmove = &punk_move_walk_grenade_sht;
		else if(!strcmp(self->gesture[n],"punk_move_walk_flamegun_sht"))
		   self->cast_info.currentmove = &punk_move_walk_flamegun_sht;
		else if(!strcmp(self->gesture[n],"punk_move_walk_shg_sht"))
		   self->cast_info.currentmove = &punk_move_walk_shg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_walk_gdown"))
		   self->cast_info.currentmove = &punk_move_walk_gdown;
		else if(!strcmp(self->gesture[n],"punk_move_run_nw"))
		   self->cast_info.currentmove = &punk_move_run_nw;
		else if(!strcmp(self->gesture[n],"punk_move_run_tg_sht"))
		   self->cast_info.currentmove = &punk_move_run_tg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_reverse_tg_sht"))
		   self->cast_info.currentmove = &punk_move_run_reverse_tg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_hmg_sht"))
		   self->cast_info.currentmove = &punk_move_run_hmg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_reverse_hmg_sht"))
		   self->cast_info.currentmove = &punk_move_run_reverse_hmg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_bazooka_sht"))
		   self->cast_info.currentmove = &punk_move_run_bazooka_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_reverse_bazooka_sht"))
		   self->cast_info.currentmove = &punk_move_run_reverse_bazooka_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_grenade_sht"))
		   self->cast_info.currentmove = &punk_move_run_grenade_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_reverse_grenade_sht"))
		   self->cast_info.currentmove = &punk_move_run_reverse_grenade_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_flamegun_sht"))
		   self->cast_info.currentmove = &punk_move_run_flamegun_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_reverse_flamegun_sht"))
		   self->cast_info.currentmove = &punk_move_run_reverse_flamegun_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_shg_sht"))
		   self->cast_info.currentmove = &punk_move_run_shg_sht;
		else if(!strcmp(self->gesture[n],"punk_move_run_gun_down"))
		   self->cast_info.currentmove = &punk_move_run_gun_down;
		else if(!strcmp(self->gesture[n],"punk_move_run_on_fire"))
		   self->cast_info.currentmove = &punk_move_run_on_fire;
		else if(!strcmp(self->gesture[n],"punk_move_lsd_tg_run"))
		   self->cast_info.currentmove = &punk_move_lsd_tg_run;
		else if(!strcmp(self->gesture[n],"punk_move_rsd_tg_run"))
		   self->cast_info.currentmove = &punk_move_rsd_tg_run;
		else if(!strcmp(self->gesture[n],"punk_move_lsd_hmg_run"))
		   self->cast_info.currentmove = &punk_move_lsd_hmg_run;
		else if(!strcmp(self->gesture[n],"punk_move_rsd_hmg_run"))
		   self->cast_info.currentmove = &punk_move_rsd_hmg_run;
		else if(!strcmp(self->gesture[n],"punk_move_lsd_bazooka_run"))
		   self->cast_info.currentmove = &punk_move_lsd_bazooka_run;
		else if(!strcmp(self->gesture[n],"punk_move_rsd_bazooka_run"))
		   self->cast_info.currentmove = &punk_move_rsd_bazooka_run;
		else if(!strcmp(self->gesture[n],"punk_move_lsd_grenade_run"))
		   self->cast_info.currentmove = &punk_move_lsd_grenade_run;
		else if(!strcmp(self->gesture[n],"punk_move_rsd_grenade_run"))
		   self->cast_info.currentmove = &punk_move_rsd_grenade_run;
		else if(!strcmp(self->gesture[n],"punk_move_lsd_flamegun_run"))
		   self->cast_info.currentmove = &punk_move_lsd_flamegun_run;
		else if(!strcmp(self->gesture[n],"punk_move_rsd_flamegun_run"))
		   self->cast_info.currentmove = &punk_move_rsd_flamegun_run;
		else if(!strcmp(self->gesture[n],"punk_move_lsd_shg_run"))
		   self->cast_info.currentmove = &punk_move_lsd_shg_run;
		else if(!strcmp(self->gesture[n],"punk_move_rsd_shg_run"))
		   self->cast_info.currentmove = &punk_move_rsd_shg_run;
		else if(!strcmp(self->gesture[n],"punk_move_avoid_walk"))
		   self->cast_info.currentmove = &punk_move_avoid_walk;
		else if(!strcmp(self->gesture[n],"punk_move_avoid_crouch_walk"))
		   self->cast_info.currentmove = &punk_move_avoid_crouch_walk;
		else if(!strcmp(self->gesture[n],"punk_move_walk_gdownFLASHLIGHT"))
		   self->cast_info.currentmove = &punk_move_walk_gdownFLASHLIGHT;
		else if(!strcmp(self->gesture[n],"punk_move_avoid_run"))
		   self->cast_info.currentmove = &punk_move_avoid_run;
		else if(!strcmp(self->gesture[n],"punk_move_avoid_reverse_walk"))
		   self->cast_info.currentmove = &punk_move_avoid_reverse_walk;
		else if(!strcmp(self->gesture[n],"punk_move_avoid_reverse_run"))
		   self->cast_info.currentmove = &punk_move_avoid_reverse_run;
		else if(!strcmp(self->gesture[n],"punk_move_sg_stand"))
		   self->cast_info.currentmove = &punk_move_sg_stand;
		else if(!strcmp(self->gesture[n],"punk_move_sg_talk1"))
		   self->cast_info.currentmove = &punk_move_sg_talk1;
		else if(!strcmp(self->gesture[n],"punk_move_sg_talk2"))
		   self->cast_info.currentmove = &punk_move_sg_talk2;
		else if(!strcmp(self->gesture[n],"punk_move_sg_talk3"))
		   self->cast_info.currentmove = &punk_move_sg_talk3;
		else if(!strcmp(self->gesture[n],"punk_move_sg_talk4"))
		   self->cast_info.currentmove = &punk_move_sg_talk4;
		else if(!strcmp(self->gesture[n],"punk_move_sg_talk5"))
		   self->cast_info.currentmove = &punk_move_sg_talk5;
		else if(!strcmp(self->gesture[n],"punk_move_sg_talk6"))
		   self->cast_info.currentmove = &punk_move_sg_talk6;
		else if(!strcmp(self->gesture[n],"punk_move_walk_dokey"))
		   self->cast_info.currentmove = &punk_move_walk_dokey;
		else if(!strcmp(self->gesture[n],"punk_move_crch_dokey"))
		   self->cast_info.currentmove = &punk_move_crch_dokey;
		else if(!strcmp(self->gesture[n],"punk_move_hmg_shoot2"))
		   self->cast_info.currentmove = &punk_move_hmg_shoot2;
		else if(!strcmp(self->gesture[n],"punk_move_walk_hmg_sht2"))
		   self->cast_info.currentmove = &punk_move_walk_hmg_sht2;
		else if(!strcmp(self->gesture[n],"punk_move_run_hmg_sht2"))
		   self->cast_info.currentmove = &punk_move_run_hmg_sht2;
		else if(!strcmp(self->gesture[n],"punk_move_bazooka_shoot2"))
		   self->cast_info.currentmove = &punk_move_bazooka_shoot2;
		else if(!strcmp(self->gesture[n],"punk_move_walk_bazooka_shoot2"))
		   self->cast_info.currentmove = &punk_move_walk_bazooka_shoot2;
		else if(!strcmp(self->gesture[n],"punk_move_run_bazooka_shoot2"))
		   self->cast_info.currentmove = &punk_move_run_bazooka_shoot2;
		else self->cast_info.currentmove = &punk_move_stand;
