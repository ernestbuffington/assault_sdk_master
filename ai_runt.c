...
void runt_melee( edict_t *self )
{
	...
	if(self->dmg) damage = (float)self->dmg;
...
//	self->cast_info.move_start_climb = &runt_move_st_clmb;
	...
	if (self->spawnflags & 128) self->s.renderfx2 |= RF2_NOSHADOW;
...
/************************************************
qboolean CheckRuntScripts(edict_t *self)
...
Allows scripts to run for cast_runt etc.
*************************************************/
...
qboolean CheckRuntScripts(edict_t *self)
{
	...
	if(    self->count > -1 
		&& !strcmp(self->classname,"cast_runt") 
		&& self->gesture[n] ) // assault virgin11beta
	{

		CHECKPLAYSOUND

		else if(!strcmp(self->gesture[n],"runt_attack"))	
		{
		...
		n = self->option - self->count;
			 ...
			 if(!strcmp(self->gesture[n],"wait") || !strcmp(self->gesture[n],"runt_move_amb_stand") )
		   self->cast_info.currentmove = &runt_move_amb_stand;
		else if(!strcmp(self->gesture[n],"runt_move_talk1"))
		   self->cast_info.currentmove = &runt_move_talk1;
		else if(!strcmp(self->gesture[n],"runt_move_talk2"))
		   self->cast_info.currentmove = &runt_move_talk2;
		else if(!strcmp(self->gesture[n],"runt_move_talk3"))
		   self->cast_info.currentmove = &runt_move_talk3;
		else if(!strcmp(self->gesture[n],"runt_move_talk4"))
		   self->cast_info.currentmove = &runt_move_talk4;
		else if(!strcmp(self->gesture[n],"runt_move_talk5"))
		   self->cast_info.currentmove = &runt_move_talk5;
		else if(!strcmp(self->gesture[n],"runt_move_talk6"))
		   self->cast_info.currentmove = &runt_move_talk6;
		else if(!strcmp(self->gesture[n],"runt_move_talk7"))
		   self->cast_info.currentmove = &runt_move_talk7;
		else if(!strcmp(self->gesture[n],"runt_move_talk8"))
		   self->cast_info.currentmove = &runt_move_talk8;
		else if(!strcmp(self->gesture[n],"runt_move_pull_guns"))
		   self->cast_info.currentmove = &runt_move_pull_guns;
		else if(!strcmp(self->gesture[n],"runt_move_shoot"))
		   self->cast_info.currentmove = &runt_move_shoot;
		else if(!strcmp(self->gesture[n],"runt_move_reload"))
		   self->cast_info.currentmove = &runt_move_reload;
		else if(!strcmp(self->gesture[n],"runt_move_kneel"))
		   self->cast_info.currentmove = &runt_move_kneel;
		else if(!strcmp(self->gesture[n],"runt_move_kneel_up"))
		   self->cast_info.currentmove = &runt_move_kneel_up;
		else if(!strcmp(self->gesture[n],"runt_move_knl_shoot"))
		   self->cast_info.currentmove = &runt_move_knl_shoot;
		else if(!strcmp(self->gesture[n],"runt_move_melee1"))
		   self->cast_info.currentmove = &runt_move_melee1;
		else if(!strcmp(self->gesture[n],"runt_move_melee2"))
		   self->cast_info.currentmove = &runt_move_melee2;
		else if(!strcmp(self->gesture[n],"runt_move_melee3"))
		   self->cast_info.currentmove = &runt_move_melee3;
		else if(!strcmp(self->gesture[n],"runt_move_melee4"))
		   self->cast_info.currentmove = &runt_move_melee4;
		else if(!strcmp(self->gesture[n],"runt_move_melee5"))
		   self->cast_info.currentmove = &runt_move_melee5;
		else if(!strcmp(self->gesture[n],"runt_move_melee6"))
		   self->cast_info.currentmove = &runt_move_melee6;
		else if(!strcmp(self->gesture[n],"runt_move_melee_amb1"))
		   self->cast_info.currentmove = &runt_move_melee_amb1;
		else if(!strcmp(self->gesture[n],"runt_move_low_melee1"))
		   self->cast_info.currentmove = &runt_move_low_melee1;
		else if(!strcmp(self->gesture[n],"runt_move_low_melee2"))
		   self->cast_info.currentmove = &runt_move_low_melee2;
		else if(!strcmp(self->gesture[n],"runt_move_low_melee3"))
		   self->cast_info.currentmove = &runt_move_low_melee3;
		else if(!strcmp(self->gesture[n],"runt_move_low_melee4"))
		   self->cast_info.currentmove = &runt_move_low_melee4;
		else if(!strcmp(self->gesture[n],"runt_move_low_melee5"))
		   self->cast_info.currentmove = &runt_move_low_melee5;
		else if(!strcmp(self->gesture[n],"runt_move_lw_melee_a"))
		   self->cast_info.currentmove = &runt_move_lw_melee_a;
		else if(!strcmp(self->gesture[n],"runt_move_jump"))
		   self->cast_info.currentmove = &runt_move_jump;
		else if(!strcmp(self->gesture[n],"runt_move_pstl_jump"))
		   self->cast_info.currentmove = &runt_move_pstl_jump;
		else if(!strcmp(self->gesture[n],"runt_move_pain_Rarm"))
		   self->cast_info.currentmove = &runt_move_pain_Rarm;
		else if(!strcmp(self->gesture[n],"runt_move_pain_Larm"))
		   self->cast_info.currentmove = &runt_move_pain_Larm;
		else if(!strcmp(self->gesture[n],"runt_move_pain_chst"))
		   self->cast_info.currentmove = &runt_move_pain_chst;
		else if(!strcmp(self->gesture[n],"runt_move_pain_head"))
		   self->cast_info.currentmove = &runt_move_pain_head;
		else if(!strcmp(self->gesture[n],"runt_move_pain_Rleg"))
		   self->cast_info.currentmove = &runt_move_pain_Rleg;
		else if(!strcmp(self->gesture[n],"runt_move_pain_Lleg"))
		   self->cast_info.currentmove = &runt_move_pain_Lleg;
		else if(!strcmp(self->gesture[n],"runt_move_pain_crch"))
		   self->cast_info.currentmove = &runt_move_pain_crch;
		else if(!strcmp(self->gesture[n],"runt_move_pain_butt"))
		   self->cast_info.currentmove = &runt_move_pain_butt;
		else if(!strcmp(self->gesture[n],"runt_move_nw_pain_Rarm"))
		   self->cast_info.currentmove = &runt_move_nw_pain_Rarm;
		else if(!strcmp(self->gesture[n],"runt_move_nw_pain_Larm"))
		   self->cast_info.currentmove = &runt_move_nw_pain_Larm;
		else if(!strcmp(self->gesture[n],"runt_move_nw_pain_chst"))
		   self->cast_info.currentmove = &runt_move_nw_pain_chst;
		else if(!strcmp(self->gesture[n],"runt_move_nw_pain_crch"))
		   self->cast_info.currentmove = &runt_move_nw_pain_crch;
		else if(!strcmp(self->gesture[n],"runt_move_nw_pain_butt"))
		   self->cast_info.currentmove = &runt_move_nw_pain_butt;
		else if(!strcmp(self->gesture[n],"runt_move_nw_pain_head"))
		   self->cast_info.currentmove = &runt_move_nw_pain_head;
		else if(!strcmp(self->gesture[n],"runt_move_nw_pain_Rleg"))
		   self->cast_info.currentmove = &runt_move_nw_pain_Rleg;
		else if(!strcmp(self->gesture[n],"runt_move_nw_pain_Lleg"))
		   self->cast_info.currentmove = &runt_move_nw_pain_Lleg;
		else if(!strcmp(self->gesture[n],"runt_move_death1"))
		   self->cast_info.currentmove = &runt_move_death1;
		else if(!strcmp(self->gesture[n],"runt_move_death2"))
		   self->cast_info.currentmove = &runt_move_death2;
		else if(!strcmp(self->gesture[n],"runt_move_death3"))
		   self->cast_info.currentmove = &runt_move_death3;
		else if(!strcmp(self->gesture[n],"runt_move_death4"))
		   self->cast_info.currentmove = &runt_move_death4;
		else if(!strcmp(self->gesture[n],"runt_move_death5"))
		   self->cast_info.currentmove = &runt_move_death5;
		else if(!strcmp(self->gesture[n],"runt_move_death6"))
		   self->cast_info.currentmove = &runt_move_death6;
		else if(!strcmp(self->gesture[n],"runt_move_crch_amb_sdt"))
		   self->cast_info.currentmove = &runt_move_crch_amb_sdt;
		else if(!strcmp(self->gesture[n],"runt_move_crch_shoot"))
		   self->cast_info.currentmove = &runt_move_crch_shoot;
		else if(!strcmp(self->gesture[n],"runt_move_crouch_walk"))
		   self->cast_info.currentmove = &runt_move_crouch_walk;
		else if(!strcmp(self->gesture[n],"runt_move_c_pain_Rarm"))
		   self->cast_info.currentmove = &runt_move_c_pain_Rarm;
		else if(!strcmp(self->gesture[n],"runt_move_c_pain_Larm"))
		   self->cast_info.currentmove = &runt_move_c_pain_Larm;
		else if(!strcmp(self->gesture[n],"runt_move_c_pain_chst"))
		   self->cast_info.currentmove = &runt_move_c_pain_chst;
		else if(!strcmp(self->gesture[n],"runt_move_c_pain_head"))
		   self->cast_info.currentmove = &runt_move_c_pain_head;
		else if(!strcmp(self->gesture[n],"runt_move_evade"))
		   self->cast_info.currentmove = &runt_move_evade;
		else if(!strcmp(self->gesture[n],"runt_move_evade_amb"))
		   self->cast_info.currentmove = &runt_move_evade_amb;
		else if(!strcmp(self->gesture[n],"runt_move_evade_stand"))
		   self->cast_info.currentmove = &runt_move_evade_stand;
		else if(!strcmp(self->gesture[n],"runt_move_lside_step"))
		   self->cast_info.currentmove = &runt_move_lside_step;
		else if(!strcmp(self->gesture[n],"runt_move_rside_step"))
		   self->cast_info.currentmove = &runt_move_rside_step;
		else if(!strcmp(self->gesture[n],"runt_move_walk_guns_dn"))
		   self->cast_info.currentmove = &runt_move_walk_guns_dn;
		else if(!strcmp(self->gesture[n],"runt_move_walk_shoot"))
		   self->cast_info.currentmove = &runt_move_walk_shoot;
		else if(!strcmp(self->gesture[n],"runt_move_run_guns_dn"))
		   self->cast_info.currentmove = &runt_move_run_guns_dn;
		else if(!strcmp(self->gesture[n],"runt_move_run_shoot"))
		   self->cast_info.currentmove = &runt_move_run_shoot;
		else if(!strcmp(self->gesture[n],"runt_move_reverse_run_shoot"))
		   self->cast_info.currentmove = &runt_move_reverse_run_shoot;
		else if(!strcmp(self->gesture[n],"runt_move_run_on_fire"))
		   self->cast_info.currentmove = &runt_move_run_on_fire;
		else if(!strcmp(self->gesture[n],"runt_move_run_melee"))
		   self->cast_info.currentmove = &runt_move_run_melee;
		else if(!strcmp(self->gesture[n],"runt_move_lside_run"))
		   self->cast_info.currentmove = &runt_move_lside_run;
		else if(!strcmp(self->gesture[n],"runt_move_rside_run"))
		   self->cast_info.currentmove = &runt_move_rside_run;
		else if(!strcmp(self->gesture[n],"runt_move_crch_death1"))
		   self->cast_info.currentmove = &runt_move_crch_death1;
		else if(!strcmp(self->gesture[n],"runt_move_crch_death2"))
		   self->cast_info.currentmove = &runt_move_crch_death2;
		else if(!strcmp(self->gesture[n],"runt_move_crch_death3"))
		   self->cast_info.currentmove = &runt_move_crch_death3;
		else if(!strcmp(self->gesture[n],"runt_move_clmb_loop"))
		   self->cast_info.currentmove = &runt_move_clmb_loop;
		else if(!strcmp(self->gesture[n],"runt_move_clmb_over"))
		   self->cast_info.currentmove = &runt_move_clmb_over;
		else if(!strcmp(self->gesture[n],"runt_move_clmb_jmp"))
		   self->cast_info.currentmove = &runt_move_clmb_jmp;
		else if(!strcmp(self->gesture[n],"runt_move_evade_adjust"))
		   self->cast_info.currentmove = &runt_move_evade_adjust;
		else if(!strcmp(self->gesture[n],"runt_move_avoid_walk"))
		   self->cast_info.currentmove = &runt_move_avoid_walk;
		else if(!strcmp(self->gesture[n],"runt_move_avoid_reverse_walk"))
		   self->cast_info.currentmove = &runt_move_avoid_reverse_walk;
		else if(!strcmp(self->gesture[n],"runt_move_crouch_avoid_walk"))
		   self->cast_info.currentmove = &runt_move_crouch_avoid_walk;
		else if(!strcmp(self->gesture[n],"runt_move_reverse_walk_shoot"))
		   self->cast_info.currentmove = &runt_move_reverse_walk_shoot;
		else if(!strcmp(self->gesture[n],"runt_move_avoid_run"))
		   self->cast_info.currentmove = &runt_move_avoid_run;
		else if(!strcmp(self->gesture[n],"runt_move_avoid_reverse_run"))
		   self->cast_info.currentmove = &runt_move_avoid_reverse_run;
		else if(!strcmp(self->gesture[n],"runt_move_stand_up"))
		   self->cast_info.currentmove = &runt_move_stand_up;
		else if(!strcmp(self->gesture[n],"runt_move_crouch_dn"))
		   self->cast_info.currentmove = &runt_move_crouch_dn;
		else if(!strcmp(self->gesture[n],"runt_move_evade_stand2"))
		   self->cast_info.currentmove = &runt_move_evade_stand2;
		else if(!strcmp(self->gesture[n],"runt_move_walk_dokey"))
		   self->cast_info.currentmove = &runt_move_walk_dokey;
		else if(!strcmp(self->gesture[n],"runt_move_crch_dokey"))
		   self->cast_info.currentmove = &runt_move_crch_dokey;
		else self->cast_info.currentmove = &runt_move_amb_stand;
