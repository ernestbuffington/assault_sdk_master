...
/************************************************
qboolean CheckThug2Scripts(edict_t *self)
...
Allows scripts to run for cast_thug_sit etc.
*************************************************/
...
qboolean CheckThug2Scripts(edict_t *self)
{
	...
	if(    self->count > -1 
		&& !strcmp(self->classname,"cast_thug_sit") 
		&& self->gesture[n] ) // assault virgin13
	{
		CHECKPLAYSOUND

		else if(!strcmp(self->gesture[n],"thug2_attack"))	
		{
		...
		n = self->option - self->count;
			 ...
			 if(!strcmp(self->gesture[n],"wait") || !strcmp(self->gesture[n],"thug2_move_sitdn1") )
		   self->cast_info.currentmove = &thug2_move_sitdn1;
		else if(!strcmp(self->gesture[n],"thug2_move_sitdn2"))
		   self->cast_info.currentmove = &thug2_move_sitdn2;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit1"))
		   self->cast_info.currentmove = &thug2_move_ambsit1;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit2"))
		   self->cast_info.currentmove = &thug2_move_ambsit2;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit3"))
		   self->cast_info.currentmove = &thug2_move_ambsit3;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit4"))
		   self->cast_info.currentmove = &thug2_move_ambsit4;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit5"))
		   self->cast_info.currentmove = &thug2_move_ambsit5;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit6"))
		   self->cast_info.currentmove = &thug2_move_ambsit6;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit7"))
		   self->cast_info.currentmove = &thug2_move_ambsit7;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit8"))
		   self->cast_info.currentmove = &thug2_move_ambsit8;
		else if(!strcmp(self->gesture[n],"thug2_move_ambsit9"))
		   self->cast_info.currentmove = &thug2_move_ambsit9;
		else if(!strcmp(self->gesture[n],"thug2_move_cards1"))
		   self->cast_info.currentmove = &thug2_move_cards1;
		else if(!strcmp(self->gesture[n],"thug2_move_cards2"))
		   self->cast_info.currentmove = &thug2_move_cards2;
		else if(!strcmp(self->gesture[n],"thug2_move_cards3"))
		   self->cast_info.currentmove = &thug2_move_cards3;
		else if(!strcmp(self->gesture[n],"thug2_move_cards4"))
		   self->cast_info.currentmove = &thug2_move_cards4;
		else if(!strcmp(self->gesture[n],"thug2_move_cards5"))
		   self->cast_info.currentmove = &thug2_move_cards5;
		else if(!strcmp(self->gesture[n],"thug2_move_cards6"))
		   self->cast_info.currentmove = &thug2_move_cards6;
		else if(!strcmp(self->gesture[n],"thug2_move_cards7"))
		   self->cast_info.currentmove = &thug2_move_cards7;
		else if(!strcmp(self->gesture[n],"thug2_move_jumpup_nw"))
		   self->cast_info.currentmove = &thug2_move_jumpup_nw;
		else if(!strcmp(self->gesture[n],"thug2_move_jumpup_g"))
		   self->cast_info.currentmove = &thug2_move_jumpup_g;
		else if(!strcmp(self->gesture[n],"thug2_move_ambstand1"))
		   self->cast_info.currentmove = &thug2_move_ambstand1;
		else if(!strcmp(self->gesture[n],"thug2_move_ambstand2"))
		   self->cast_info.currentmove = &thug2_move_ambstand2;
		else if(!strcmp(self->gesture[n],"thug2_move_surrender"))
		   self->cast_info.currentmove = &thug2_move_surrender;
		else if(!strcmp(self->gesture[n],"thug2_move_surr2std"))
		   self->cast_info.currentmove = &thug2_move_surr2std;
		else if(!strcmp(self->gesture[n],"thug2_move_pull_guns"))
		   self->cast_info.currentmove = &thug2_move_pull_guns;
		else if(!strcmp(self->gesture[n],"thug2_move_shoot"))
		   self->cast_info.currentmove = &thug2_move_shoot;
		else if(!strcmp(self->gesture[n],"thug2_move_reload"))
		   self->cast_info.currentmove = &thug2_move_reload;
		else if(!strcmp(self->gesture[n],"thug2_move_kneel"))
		   self->cast_info.currentmove = &thug2_move_kneel;
		else if(!strcmp(self->gesture[n],"thug2_move_kneel_up"))
		   self->cast_info.currentmove = &thug2_move_kneel_up;
		else if(!strcmp(self->gesture[n],"thug2_move_knl_shoot"))
		   self->cast_info.currentmove = &thug2_move_knl_shoot;
		else if(!strcmp(self->gesture[n],"thug2_move_melee1"))
		   self->cast_info.currentmove = &thug2_move_melee1;
		else if(!strcmp(self->gesture[n],"thug2_move_melee2"))
		   self->cast_info.currentmove = &thug2_move_melee2;
		else if(!strcmp(self->gesture[n],"thug2_move_melee3"))
		   self->cast_info.currentmove = &thug2_move_melee3;
		else if(!strcmp(self->gesture[n],"thug2_move_melee4"))
		   self->cast_info.currentmove = &thug2_move_melee4;
		else if(!strcmp(self->gesture[n],"thug2_move_melee5"))
		   self->cast_info.currentmove = &thug2_move_melee5;
		else if(!strcmp(self->gesture[n],"thug2_move_run_melee"))
		   self->cast_info.currentmove = &thug2_move_run_melee;
		else if(!strcmp(self->gesture[n],"thug2_move_jump"))
		   self->cast_info.currentmove = &thug2_move_jump;
		else if(!strcmp(self->gesture[n],"thug2_move_walk_shoot"))
		   self->cast_info.currentmove = &thug2_move_walk_shoot;
		else if(!strcmp(self->gesture[n],"thug2_move_reverse_walk_shoot"))
		   self->cast_info.currentmove = &thug2_move_reverse_walk_shoot;
		else if(!strcmp(self->gesture[n],"thug2_move_walk_guns_dn"))
		   self->cast_info.currentmove = &thug2_move_walk_guns_dn;
		else if(!strcmp(self->gesture[n],"thug2_move_avoid_walk"))
		   self->cast_info.currentmove = &thug2_move_avoid_walk;
		else if(!strcmp(self->gesture[n],"thug2_move_avoid_reverse_walk"))
		   self->cast_info.currentmove = &thug2_move_avoid_reverse_walk;
		else if(!strcmp(self->gesture[n],"thug2_move_avoid_run"))
		   self->cast_info.currentmove = &thug2_move_avoid_run;
		else if(!strcmp(self->gesture[n],"thug2_move_avoid_reverse_run"))
		   self->cast_info.currentmove = &thug2_move_avoid_reverse_run;
		else if(!strcmp(self->gesture[n],"thug2_move_run_shoot"))
		   self->cast_info.currentmove = &thug2_move_run_shoot;
		else if(!strcmp(self->gesture[n],"thug2_move_run_guns_dn"))
		   self->cast_info.currentmove = &thug2_move_run_guns_dn;
		else if(!strcmp(self->gesture[n],"thug2_move_run_on_fire"))
		   self->cast_info.currentmove = &thug2_move_run_on_fire;
		else if(!strcmp(self->gesture[n],"thug2_move_lside_run"))
		   self->cast_info.currentmove = &thug2_move_lside_run;
		else if(!strcmp(self->gesture[n],"thug2_move_rside_run"))
		   self->cast_info.currentmove = &thug2_move_rside_run;
		else if(!strcmp(self->gesture[n],"thug2_move_lside_step"))
		   self->cast_info.currentmove = &thug2_move_lside_step;
		else if(!strcmp(self->gesture[n],"thug2_move_rside_step"))
		   self->cast_info.currentmove = &thug2_move_rside_step;
		else if(!strcmp(self->gesture[n],"thug2_move_evade"))
		   self->cast_info.currentmove = &thug2_move_evade;
		else if(!strcmp(self->gesture[n],"thug2_move_evade_amb"))
		   self->cast_info.currentmove = &thug2_move_evade_amb;
		else if(!strcmp(self->gesture[n],"thug2_move_evade_stand"))
		   self->cast_info.currentmove = &thug2_move_evade_stand;
		else if(!strcmp(self->gesture[n],"thug2_move_evade_adjust"))
		   self->cast_info.currentmove = &thug2_move_evade_adjust;
		else if(!strcmp(self->gesture[n],"thug2_move_clmb_loop"))
		   self->cast_info.currentmove = &thug2_move_clmb_loop;
		else if(!strcmp(self->gesture[n],"thug2_move_clmb_jmp"))
		   self->cast_info.currentmove = &thug2_move_clmb_jmp;
		else if(!strcmp(self->gesture[n],"thug2_move_clmb_over"))
		   self->cast_info.currentmove = &thug2_move_clmb_over;
		else if(!strcmp(self->gesture[n],"thug2_move_crch_dth"))
		   self->cast_info.currentmove = &thug2_move_crch_dth;
		else if(!strcmp(self->gesture[n],"thug2_move_crch_knl_dn"))
		   self->cast_info.currentmove = &thug2_move_crch_knl_dn;
		else if(!strcmp(self->gesture[n],"thug2_move_stand_up"))
		   self->cast_info.currentmove = &thug2_move_stand_up;
		else if(!strcmp(self->gesture[n],"thug2_move_crch_amb_sdt"))
		   self->cast_info.currentmove = &thug2_move_crch_amb_sdt;
		else if(!strcmp(self->gesture[n],"thug2_move_crch_shoot"))
		   self->cast_info.currentmove = &thug2_move_crch_shoot;
		else if(!strcmp(self->gesture[n],"thug2_move_crouch_avoid_walk"))
		   self->cast_info.currentmove = &thug2_move_crouch_avoid_walk;
		else if(!strcmp(self->gesture[n],"thug2_move_crouch_shfl"))
		   self->cast_info.currentmove = &thug2_move_crouch_shfl;
		else if(!strcmp(self->gesture[n],"thug2_move_crouch_walk"))
		   self->cast_info.currentmove = &thug2_move_crouch_walk;
		else if(!strcmp(self->gesture[n],"thug2_move_crouch_pain1"))
		   self->cast_info.currentmove = &thug2_move_crouch_pain1;
		else if(!strcmp(self->gesture[n],"thug2_move_crouch_pain2"))
		   self->cast_info.currentmove = &thug2_move_crouch_pain2;
		else if(!strcmp(self->gesture[n],"thug2_move_crouch_pain3"))
		   self->cast_info.currentmove = &thug2_move_crouch_pain3;
		else if(!strcmp(self->gesture[n],"thug2_move_low_melee1"))
		   self->cast_info.currentmove = &thug2_move_low_melee1;
		else if(!strcmp(self->gesture[n],"thug2_move_pain_Rarm"))
		   self->cast_info.currentmove = &thug2_move_pain_Rarm;
		else if(!strcmp(self->gesture[n],"thug2_move_pain_Larm"))
		   self->cast_info.currentmove = &thug2_move_pain_Larm;
		else if(!strcmp(self->gesture[n],"thug2_move_pain_chest"))
		   self->cast_info.currentmove = &thug2_move_pain_chest;
		else if(!strcmp(self->gesture[n],"thug2_move_pain_head"))
		   self->cast_info.currentmove = &thug2_move_pain_head;
		else if(!strcmp(self->gesture[n],"thug2_move_pain_Rleg"))
		   self->cast_info.currentmove = &thug2_move_pain_Rleg;
		else if(!strcmp(self->gesture[n],"thug2_move_pain_Lleg"))
		   self->cast_info.currentmove = &thug2_move_pain_Lleg;
		else if(!strcmp(self->gesture[n],"thug2_move_pain_crch"))
		   self->cast_info.currentmove = &thug2_move_pain_crch;
		else if(!strcmp(self->gesture[n],"thug2_move_pain_butt"))
		   self->cast_info.currentmove = &thug2_move_pain_butt;
		else if(!strcmp(self->gesture[n],"thug2_move_nw_pain_Rarm"))
		   self->cast_info.currentmove = &thug2_move_nw_pain_Rarm;
		else if(!strcmp(self->gesture[n],"thug2_move_nw_pain_Larm"))
		   self->cast_info.currentmove = &thug2_move_nw_pain_Larm;
		else if(!strcmp(self->gesture[n],"thug2_move_nw_pain_chst"))
		   self->cast_info.currentmove = &thug2_move_nw_pain_chst;
		else if(!strcmp(self->gesture[n],"thug2_move_nw_pain_head"))
		   self->cast_info.currentmove = &thug2_move_nw_pain_head;
		else if(!strcmp(self->gesture[n],"thug2_move_nw_pain_Rleg"))
		   self->cast_info.currentmove = &thug2_move_nw_pain_Rleg;
		else if(!strcmp(self->gesture[n],"thug2_move_nw_pain_Lleg"))
		   self->cast_info.currentmove = &thug2_move_nw_pain_Lleg;
		else if(!strcmp(self->gesture[n],"thug2_move_nw_pain_crch"))
		   self->cast_info.currentmove = &thug2_move_nw_pain_crch;
		else if(!strcmp(self->gesture[n],"thug2_move_nw_pain_butt"))
		   self->cast_info.currentmove = &thug2_move_nw_pain_butt;
		else if(!strcmp(self->gesture[n],"thug2_move_death1"))
		   self->cast_info.currentmove = &thug2_move_death1;
		else if(!strcmp(self->gesture[n],"thug2_move_death2"))
		   self->cast_info.currentmove = &thug2_move_death2;
		else if(!strcmp(self->gesture[n],"thug2_move_death3"))
		   self->cast_info.currentmove = &thug2_move_death3;
		else if(!strcmp(self->gesture[n],"thug2_move_death4"))
		   self->cast_info.currentmove = &thug2_move_death4;
		else if(!strcmp(self->gesture[n],"thug2_move_death5"))
		   self->cast_info.currentmove = &thug2_move_death5;
		else self->cast_info.currentmove = &thug2_move_sitdn1;
