...
void bitch_talk( edict_t *self )
{
	...
	switch(((rand() % 11)+1))
	{
		...
		break;
		default:
		self->cast_info.currentmove = &bitch_move_leanwave;
		break;
	}
}
...
/************************************************
qboolean CheckBitchScripts(edict_t *self)
...
Allows scripts to run for cast_bitch etc.
*************************************************/
...
qboolean CheckBitchScripts(edict_t *self)
{
	...
	if(    self->count > -1 
		&& !strcmp(self->classname,"cast_bitch") 
		&& self->gesture[n] ) // assault virgin11beta
	{

		CHECKPLAYSOUND

		else if(!strcmp(self->gesture[n],"bitch_attack"))	
		{
		...
		n = self->option - self->count;
			 ...
			 if(!strcmp(self->gesture[n],"wait") || !strcmp(self->gesture[n],"bitch_move_boredA") )
		   self->cast_info.currentmove = &bitch_move_boredA;
		else if(!strcmp(self->gesture[n],"bitch_move_leanlook"))
		   self->cast_info.currentmove = &bitch_move_leanlook;
		else if(!strcmp(self->gesture[n],"bitch_move_leanwave"))
		   self->cast_info.currentmove = &bitch_move_leanwave;
		else if(!strcmp(self->gesture[n],"bitch_move_whatsup"))
		   self->cast_info.currentmove = &bitch_move_whatsup;
		else if(!strcmp(self->gesture[n],"bitch_move_talkme"))
		   self->cast_info.currentmove = &bitch_move_talkme;
		else if(!strcmp(self->gesture[n],"bitch_move_nonono"))
		   self->cast_info.currentmove = &bitch_move_nonono;
		else if(!strcmp(self->gesture[n],"bitch_move_comeon"))
		   self->cast_info.currentmove = &bitch_move_comeon;
		else if(!strcmp(self->gesture[n],"bitch_move_getdown"))
		   self->cast_info.currentmove = &bitch_move_getdown;
		else if(!strcmp(self->gesture[n],"bitch_move_whomw"))
		   self->cast_info.currentmove = &bitch_move_whomw;
		else if(!strcmp(self->gesture[n],"bitch_move_lookself"))
		   self->cast_info.currentmove = &bitch_move_lookself;
		else if(!strcmp(self->gesture[n],"bitch_move_flirt"))
		   self->cast_info.currentmove = &bitch_move_flirt;
		else if(!strcmp(self->gesture[n],"bitch_move_walk_shoot"))
		   self->cast_info.currentmove = &bitch_move_walk_shoot;
		else if(!strcmp(self->gesture[n],"bitch_move_walk_guns_dn"))
		   self->cast_info.currentmove = &bitch_move_walk_guns_dn;
		else if(!strcmp(self->gesture[n],"bitch_move_run_shoot"))
		   self->cast_info.currentmove = &bitch_move_run_shoot;
		else if(!strcmp(self->gesture[n],"bitch_move_reverse_run_shoot"))
		   self->cast_info.currentmove = &bitch_move_reverse_run_shoot;
		else if(!strcmp(self->gesture[n],"bitch_move_run_guns_dn"))
		   self->cast_info.currentmove = &bitch_move_run_guns_dn;
		else if(!strcmp(self->gesture[n],"bitch_move_lside_run"))
		   self->cast_info.currentmove = &bitch_move_lside_run;
		else if(!strcmp(self->gesture[n],"bitch_move_rside_run"))
		   self->cast_info.currentmove = &bitch_move_rside_run;
		else if(!strcmp(self->gesture[n],"bitch_move_run_on_fire"))
		   self->cast_info.currentmove = &bitch_move_run_on_fire;
		else if(!strcmp(self->gesture[n],"bitch_move_evd_walk"))
		   self->cast_info.currentmove = &bitch_move_evd_walk;
		else if(!strcmp(self->gesture[n],"bitch_move_evade_adjust"))
		   self->cast_info.currentmove = &bitch_move_evade_adjust;
		else if(!strcmp(self->gesture[n],"bitch_move_evd_amb"))
		   self->cast_info.currentmove = &bitch_move_evd_amb;
		else if(!strcmp(self->gesture[n],"bitch_move_evd_stand"))
		   self->cast_info.currentmove = &bitch_move_evd_stand;
		else if(!strcmp(self->gesture[n],"bitch_move_pull_gun"))
		   self->cast_info.currentmove = &bitch_move_pull_gun;
		else if(!strcmp(self->gesture[n],"bitch_move_shoot_stand"))
		   self->cast_info.currentmove = &bitch_move_shoot_stand;
		else if(!strcmp(self->gesture[n],"bitch_move_reload"))
		   self->cast_info.currentmove = &bitch_move_reload;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_chst"))
		   self->cast_info.currentmove = &bitch_move_p_pain_chst;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_rshd"))
		   self->cast_info.currentmove = &bitch_move_p_pain_rshd;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_lshd"))
		   self->cast_info.currentmove = &bitch_move_p_pain_lshd;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_rshd2"))
		   self->cast_info.currentmove = &bitch_move_p_pain_rshd2;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_rleg"))
		   self->cast_info.currentmove = &bitch_move_p_pain_rleg;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_lleg"))
		   self->cast_info.currentmove = &bitch_move_p_pain_lleg;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_crch"))
		   self->cast_info.currentmove = &bitch_move_p_pain_crch;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_butt"))
		   self->cast_info.currentmove = &bitch_move_p_pain_butt;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_lshd2"))
		   self->cast_info.currentmove = &bitch_move_p_pain_lshd2;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_rleg2"))
		   self->cast_info.currentmove = &bitch_move_p_pain_rleg2;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_lleg2"))
		   self->cast_info.currentmove = &bitch_move_p_pain_lleg2;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_crch2"))
		   self->cast_info.currentmove = &bitch_move_p_pain_crch2;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_butt2"))
		   self->cast_info.currentmove = &bitch_move_p_pain_butt2;
		else if(!strcmp(self->gesture[n],"bitch_move_p_pain_head2"))
		   self->cast_info.currentmove = &bitch_move_p_pain_head2;
		else if(!strcmp(self->gesture[n],"bitch_move_death1"))
		   self->cast_info.currentmove = &bitch_move_death1;
		else if(!strcmp(self->gesture[n],"bitch_move_death2"))
		   self->cast_info.currentmove = &bitch_move_death2;
		else if(!strcmp(self->gesture[n],"bitch_move_death3"))
		   self->cast_info.currentmove = &bitch_move_death3;
		else if(!strcmp(self->gesture[n],"bitch_move_death4"))
		   self->cast_info.currentmove = &bitch_move_death4;
		else if(!strcmp(self->gesture[n],"bitch_move_death5"))
		   self->cast_info.currentmove = &bitch_move_death5;
		else if(!strcmp(self->gesture[n],"bitch_move_avoid_walk"))
		   self->cast_info.currentmove = &bitch_move_avoid_walk;
		else if(!strcmp(self->gesture[n],"bitch_move_avoid_reverse_walk"))
		   self->cast_info.currentmove = &bitch_move_avoid_reverse_walk;
		else if(!strcmp(self->gesture[n],"bitch_move_crch_avoid_walk"))
		   self->cast_info.currentmove = &bitch_move_crch_avoid_walk;
		else if(!strcmp(self->gesture[n],"bitch_move_avoid_run"))
		   self->cast_info.currentmove = &bitch_move_avoid_run;
		else if(!strcmp(self->gesture[n],"bitch_move_avoid_reverse_run"))
		   self->cast_info.currentmove = &bitch_move_avoid_reverse_run;
		else if(!strcmp(self->gesture[n],"bitch4_move_stnd2melee"))
		   self->cast_info.currentmove = &bitch4_move_stnd2melee;
		else if(!strcmp(self->gesture[n],"bitch4_move_melee2stnd"))
		   self->cast_info.currentmove = &bitch4_move_melee2stnd;
		else if(!strcmp(self->gesture[n],"bitch4_move_melee_amb"))
		   self->cast_info.currentmove = &bitch4_move_melee_amb;
		else if(!strcmp(self->gesture[n],"bitch4_move_low_melee1"))
		   self->cast_info.currentmove = &bitch4_move_low_melee1;
		else if(!strcmp(self->gesture[n],"bitch4_move_melee1"))
		   self->cast_info.currentmove = &bitch4_move_melee1;
		else if(!strcmp(self->gesture[n],"bitch4_move_melee3"))
		   self->cast_info.currentmove = &bitch4_move_melee3;
		else if(!strcmp(self->gesture[n],"bitch4_move_run_melee"))
		   self->cast_info.currentmove = &bitch4_move_run_melee;
		else if(!strcmp(self->gesture[n],"bitch4_move_jump"))
		   self->cast_info.currentmove = &bitch4_move_jump;
		else if(!strcmp(self->gesture[n],"bitch4_move_lside_step"))
		   self->cast_info.currentmove = &bitch4_move_lside_step;
		else if(!strcmp(self->gesture[n],"bitch4_move_rside_step"))
		   self->cast_info.currentmove = &bitch4_move_rside_step;
		else if(!strcmp(self->gesture[n],"bitch4_move_st_climb"))
		   self->cast_info.currentmove = &bitch4_move_st_climb;
		else if(!strcmp(self->gesture[n],"bitch4_move_clmb_loop"))
		   self->cast_info.currentmove = &bitch4_move_clmb_loop;
		else if(!strcmp(self->gesture[n],"bitch4_move_clmb_jmp"))
		   self->cast_info.currentmove = &bitch4_move_clmb_jmp;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_dth1"))
		   self->cast_info.currentmove = &bitch4_move_crch_dth1;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_dth2"))
		   self->cast_info.currentmove = &bitch4_move_crch_dth2;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_dth3"))
		   self->cast_info.currentmove = &bitch4_move_crch_dth3;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_dth4"))
		   self->cast_info.currentmove = &bitch4_move_crch_dth4;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_knl_dn"))
		   self->cast_info.currentmove = &bitch4_move_crch_knl_dn;
		else if(!strcmp(self->gesture[n],"bitch4_move_stand_up"))
		   self->cast_info.currentmove = &bitch4_move_stand_up;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_amb_std"))
		   self->cast_info.currentmove = &bitch4_move_crch_amb_std;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_shoot"))
		   self->cast_info.currentmove = &bitch4_move_crch_shoot;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_reload"))
		   self->cast_info.currentmove = &bitch4_move_crch_reload;
		else if(!strcmp(self->gesture[n],"bitch4_move_crch_walk"))
		   self->cast_info.currentmove = &bitch4_move_crch_walk;
		else if(!strcmp(self->gesture[n],"bitch_move_walk_dokey"))
		   self->cast_info.currentmove = &bitch_move_walk_dokey;
		else self->cast_info.currentmove = &bitch_move_boredA;
